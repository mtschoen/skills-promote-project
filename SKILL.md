...
5. **CI** (`.github/workflows/`) running lint + format-check + tests. Don't skip it.
...
- **Create the remote.** `gh repo create <owner>/<name>` in the appropriate namespace (ask the user which), add `origin`, push `main`.
